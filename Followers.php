...
print "  <title>Eagle Events | Followers</title>\n";
...
print "              <h3 class=\"box-title\">Followers</h3>\n";
print "            </div>\n";
print "            <!-- /.box-header -->\n";
