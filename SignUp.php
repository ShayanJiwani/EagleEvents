...
print "                <input type=\"radio\" class=\"custom-control-input\" id=\"Freshman\" name=\"year\" value = \"Freshman\"required>\n";
print "                <label class=\"custom-control-label\" for=\"Freshman\">Freshman</label>\n";
print "              </div>\n";
print "              <div class=\"custom-control custom-radio\">\n";
print "                <input type=\"radio\" class=\"custom-control-input\" id=\"Sophomore\" name=\"year\" value = \"Sophomore\"required>\n";
print "                <label class=\"custom-control-label\" for=\"Sophomore\">Sophomore</label>\n";
print "              </div>\n";
print "              <div class=\"custom-control custom-radio\">\n";
print "                <input type=\"radio\" class=\"custom-control-input\" id=\"Junior\" name=\"year\" value = \"Junior\"required>\n";
print "                <label class=\"custom-control-label\" for=\"Junior\">Junior</label>\n";
print "              </div>\n";
print "              <div class=\"custom-control custom-radio\">\n";
print "                <input type=\"radio\" class=\"custom-control-input\" id=\"Senior\" name=\"year\" value = \"Senior\" required>\n";
print "                <label class=\"custom-control-label\" for=\"Senior\">Senior</label>\n";
print "              </div>\n";
print "              <div class=\"custom-control custom-radio\">\n";
print "                <input type=\"radio\" class=\"custom-control-input\" id=\"Graduate\" name=\"year\" value = \"Graduate\" required>\n";
