...
print "  <title>Eagle Events | Emory Events</title>\n";
...
print "            <li class=\"active\"><a href=\"AllEvents.php\"><i class=\"fa fa-table\"></i> <span>All Events</a></li>\n";
print "          </ul>\n";
print "        </li>\n";
print "      </ul>\n";
print "      <!-- /.sidebar-menu -->\n";
...
while ($row = mysqli_fetch_assoc($result)){
  ...
  print ("<td><input type=\"checkbox\" name=\"eid$counter\"  value=" . $row['event_id'] . "></td>");
  $counter++;
  print ("</tr>\n");
}
print "                  </tbody>\n";
...
print "   <input type=\"submit\" value=\"Add Events\" class=\"btn btn-sm btn-default btn-flat pull-right\">";
print "</form>";
print "            </div>\n";
print "            <!-- /.box-footer -->\n";
print "          </div>\n";
