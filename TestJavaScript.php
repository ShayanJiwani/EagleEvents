...
print "          \n";
print "          \n";
print "          //exchange this part of the code to database in order to actually connect to the real data\n";
print "          //just replace eventmap.\n";
print "          //test data\n";
print "        var eventmap = {\n";
print "            emorygaming:{\n";
print "                center:{lat: 33.792385,lng:-84.323252},\n";
print "                location: 'Cox Hall',\n";
print "                club: 'EmoryGaming',\n";
print "                dcpt: '<small>No game No life</small>',\n";
print "                name: 'Fall Tournament',\n";
print "                date: '10/24/2018',\n";
print "                start: '7:00 pm',\n";
print "                end: '9:00 pm'\n";
print "            },\n";
print "            emoryPartying:{\n";
print "                center:{lat: 33.790823,lng:-84.325964},\n";
print "                location: 'White Hall',\n";
print "                club: 'EmoryPartying',\n";
print "                dcpt: 'No drink No life',\n";
print "                name: 'Halloween Party',\n";
print "                date: '10/24/2018',\n";
print "                start: '11:00 pm',\n";
print "                end: '2:00 am'\n";
print "            },\n";
print "            emorySporting:{\n";
print "                center:{lat: 33.793276,lng:-84.325941},\n";
print "                location: 'Emory Woodruff physical education center',\n";
print "                club: 'EmoryPartying',\n";
print "                dcpt: 'No blood No life',\n";
print "                name: 'basketball game',\n";
print "                date: '10/24/2018',\n";
print "                start: '5:00 pm',\n";
print "                end: '7:00 pm'\n";
print "            },\n";
print "            emoryReading:{\n";
print "                center:{lat: 33.791297,lng:-84.323573},\n";
print "                location: 'Candler Library',\n";
print "                club: 'EmoryPartying',\n";
print "                dcpt: 'No books No life',\n";
print "                name: 'fall Poetry Contest',\n";
print "                date: '10/24/2018',\n";
print "                start: '5:00 pm',\n";
print "                end: '6:00 pm'\n";
print "            },\n";
print "            emoryEating:{\n";
print "                center:{lat: 33.794055,lng:-84.325117},\n";
print "                location: 'McDonough Field',\n";
print "                club: 'EmoryEating',\n";
print "                dcpt: 'No food No life',\n";
print "                name: 'Chinese ThanksGivings',\n";
print "                date: '10/24/2018',\n";
print "                start: '5:00 pm',\n";
print "                end: '8:00 pm'\n";
print "            }\n";
print "        };\n";
print "        lastWindow = null\n";
print "          \n";
...
print "            };\n";
print "            var map = new google.maps.Map(document.getElementById('map'),options);\n";
print "            var noPoi = [{\n";
...
print "            }];\n";
print "            \n";
print "            map.setOptions({ styles: noPoi });\n";
print "            var marker = new google.maps.Marker({\n";
print "                map: map,\n";
print "                position:{lat: 33.7925,lng:-84.3240},\n";
print "                title:'Emory Campas'\n";
print "            });\n";
print "            for (var event in eventmap){\n";
print "                addMarker(eventmap[event]);\n";
print "            }\n";
print "            function addMarker(event){\n";
print "                var marker = new google.maps.Marker({\n";
print "                    map: map,\n";
print "                    position: event.center\n";
print "                });\n";
print "                if(event.dcpt){\n";
print "                    var infoWindow = new google.maps.InfoWindow({\n";
print "                        content: event.club +\n";
print "                                \"<br/>\" + event.name +\n";
print "                                \"<br/>\" + event.dcpt +\n";
print "                                \"<br/>\" + event.date +\n";
print "                                \"<br/>\" + event.start + \" - \" + event.end +\n";
print "                                \"<br/>\" + event.location\n";
print "                    });\n";
print "                    marker.addListener('click', function(){\n";
print "                        if(lastWindow){ lastWindow.close()};\n";
print "                        infoWindow.open(map, marker);\n";
print "                        lastWindow = infoWindow;\n";
print "                    });\n";
print "                }\n";
print "            }\n";
print "            \n";
print "            var infoWindow = new google.maps.InfoWindow;\n";
print "            var currentLocation = new google.maps.Marker()\n";
...
print "                    };\n";
print "                    \n";
print "                    //customizing the dot\n";
print "                    var innerMarker = new google.maps.Marker({\n";
print "                        clickable: false,\n";
print "                        position: pos,\n";
print "                        icon:{\n";
print "                            path: google.maps.SymbolPath.CIRCLE,\n";
print "                            scale: 8,\n";
print "                            fillColor: '#00BFFF',\n";
print "                            fillOpacity: 0.8,\n";
print "                            strokeColor:'white',\n";
print "                            StrokeWeight:0,\n";
print "                            strokeOpacity: 1\n";
print "                        },\n";
print "                        map: map\n";
print "                    });\n";
print "                    var outtermarker = new google.maps.Marker({\n";
print "                        clickable: false,\n";
print "                        position: pos,\n";
print "                        icon:{\n";
print "                            path: google.maps.SymbolPath.CIRCLE,\n";
...
print "                            strokeColor:'blue',\n";
print "                            StrokeWeight:0,\n";
print "                            strokeOpacity: 0\n";
print "                        },\n";
print "                        map: map\n";
print "                    });\n";
print "                    /* this one does not increase and decrease according to zoom value\n";
print "                    var myCircle = new google.maps.Marker({\n";
...
print "                    */\n";
print "                    \n";
print "                    map.setCenter(pos);\n";
print "                }, function() {\n";
print "                    handleLocationError(true, infoWindow, map.getCenter());\n";
print "                });\n";
print "        } else {\n";
print "          // Browser doesn't support Geolocation\n";
print "          handleLocationError(false, infoWindow, map.getCenter());\n";
print "        }\n";
print "        \n";
print "      }\n";
print "\n";
print "      function handleLocationError(browserHasGeolocation, infoWindow, pos) {\n";
print "        infoWindow.setPosition(pos);\n";
print "        infoWindow.setContent(browserHasGeolocation ?\n";
